...
function Application() {
  return (
    <div style={{height:"100vh"}}><h1>Ngix Server instrumentation</h1>
        <p>
...
If you have a feature request or found a bug to report, please fill out the bug report form on the add-on's homepage </p>
    </div>
  )
}
